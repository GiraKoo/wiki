...
mkdocs build'''
      ...
      stage('Deploy') {
        steps {
          ...
          useCustomStepPlugin(key: 'SYSTEM:ssh_cmd', version: 'latest', params: [port:'22',username:'${CODING_CRED_USERNAME}',parameter:'rm ${WEB_SITE_PATH}* -rf;tar zxvf /tmp/site.tar.gz; mv site/* ${WEB_SITE_PATH} -rf',ip:'124.223.9.195',cmd:'sshCommand',password:'${CODING_CRED_PASSWORD}'])
        }
      }
