...
mkdocs build'''
      ...
      stage('Deploy') {
        steps {
          ...
          useCustomStepPlugin(key: 'SYSTEM:ssh_cmd', version: 'latest', params: [port:'22',username:'${CODING_CRED_USERNAME}',parameter:'rm ${WEB_SITE_PATH}* -rf;cd /tmp;tar zxvf /tmp/site.tar.gz;mv /tmp/site/* ${WEB_SITE_PATH} -rf',ip:'${WEB_SITE_IP}',cmd:'sshCommand',password:'${CODING_CRED_PASSWORD}'])
        }
      }
